...
public class CreditActivity extends Activity {
    ...
    protected void initView() {
        ...
        mLinearLayout.setLayoutParams(new ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        ...
        LinearLayout.LayoutParams mLayoutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, height50dp);
    ...
    protected void initNavigationBar() {
        ...
        mNavigationBar.setLayoutParams(new ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, dp20));
